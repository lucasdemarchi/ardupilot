...
public:
    ...
    /*
     * See AP_HAL::I2CDevice::set_speed()
     *
     * Empty implementation, not supported.
     */
    bool set_speed(enum Speed speed) override { return true; }

    /* See AP_HAL::I2CDevice::transfer() */
    bool transfer(const uint8_t *send, uint32_t send_len,
                  uint8_t *recv, uint32_t recv_len) override;

    /* See AP_HAL::I2CDevice::get_semaphore() */
    ...
    /* Temporary conversion function. TODO: remove */
    int get_fd() override;
