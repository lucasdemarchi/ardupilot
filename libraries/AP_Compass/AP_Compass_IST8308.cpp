...
AP_Compass_Backend *AP_Compass_IST8308::probe(Compass &compass,
                                              ...
                                              enum Rotation rotation)
{
    ...
    AP_Compass_IST8308 *sensor = new AP_Compass_IST8308(compass, std::move(dev), force_external, rotation);
...
AP_Compass_IST8308::AP_Compass_IST8308(Compass &compass,
